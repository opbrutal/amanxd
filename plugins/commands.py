...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/ABOUT_AMAN_XD'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/opbrutal/amanxd')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/opbrutal/amanxd'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/ABOUT_AMAN_XD'),     
        ],
        [
